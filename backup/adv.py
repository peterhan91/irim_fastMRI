...
def create_arg_parser():
    ...
    parser.add_argument('--npy_path', default='../Alzheimer/vol_test/cs_5')
...
if __name__ == '__main__':
    ...
    # test_files = glob.glob(os.path.join(args.npy_root, '*.npy'))
    ...
    file = np.load(args.npy_path)
    R = int(256 / args.n_keep)
    eval_dir = os.path.join(args.workdir, os.path.basename(args.npy_path).split('.')[0])
